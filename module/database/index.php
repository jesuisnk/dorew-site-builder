...
$directory = $system_root . 'assets/builder/database/' . $AuthorSite['subdomain'];
...
//constants 1
define("PROJECT", $AuthorSite['subdomain'] . '.' . $system_domain);
define("VERSION", "DorewBuilder");
...
define('PROJECT_URL','https://' . PROJECT);
...
?>
    <link href='/assets/system/css/phpLiteAdmin.css?t=<?php echo date('U') ?>' rel='stylesheet' type='text/css' />
	<!-- JavaScript Support -->
	<script type='text/javascript' src='/assets/system/js/phpLiteAdmin.js'></script>
...
echo '<div class="phdr" style="font-weight:700"><a href="/database"><i class="fa fa-database fa-lg" aria-hidden="true"></i> Cơ sở dữ liệu</a></div>';
// danh sách bảng
echo '<div class="topmenu" style="font-weight:700">Danh sách bảng</div>';
...
echo '<div class="phdr" style="backdrop-filter:blur(7px) saturate(180%);-webkit-backdrop-filter:blur(16px) saturate(180%);background-color:rgba(17,25,40,0.75);padding:4px;text-align:center;margin:0">';
if($target_table)
{
	//- HTML: tabs
...
*/
	...
	{
	    echo'<style>@media (min-width:682px){.fieldset-left{float:left; width:260px; margin-right:20px;}.fieldset-right{float:left; max-width:350px;}}</style>';
		//- Export view (=export)
		echo $params->getForm(array('view'=>'export'));
		echo "<fieldset class='fieldset-left'><legend><b>".$lang['export']."</b></legend>";
		...
		echo "<fieldset class='fieldset-right' id='exportoptions_sql'><legend><b>".$lang['options']."</b></legend>";
		...
		echo "<fieldset class='fieldset-right' style='display:none;' id='exportoptions_csv'><legend><b>".$lang['options']."</b></legend>";
		...
		$name = $save_new_db['name'];
		echo "<label>
		<input type='text' name='filename' value='".htmlencode($name)."_".date("Y-m-d").".dump' style='max-width:400px;'/> <input type='submit' name='export' value='".$lang['export']."' class='btn'/>
		</label>";
		echo "</fieldset>";
		echo "</form>";
	}
